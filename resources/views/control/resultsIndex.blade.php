	...
	<div class="panel-body">
		<table class="table table-striped table-bordered table-hover table-condensed search-table">
			...
			@foreach($controls as $control)
					<td>{!! $control->name !!}</td>
					<td>
						<a class="btn btn-sm btn-info" href="{!! url("controlresults/" . $control->id . "/resultsEntry") !!}" >
							<span class="glyphicon glyphicon-edit"></span>
							{!! trans('messages.enter-results') !!}
						</a>
						<a class="btn btn-sm btn-success" href="{!! url("controlresults/" . $control->id . "/resultsList") !!}">
