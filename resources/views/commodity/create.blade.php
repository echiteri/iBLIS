	...
	<div class="panel-body">
		   {!! Form::open(array('route' => 'commodity.store', 'id' => 'form-store_commodity', 'method' => 'POST')) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::text('name', old('commodity'), array('class' => 'form-control', 'rows' => '2')) !!}
            </div>
             <div class="form-group">
             ...
             <div class="form-group">
                ...
                {!! Form::select('unit_of_issue', array(null => '')+$metrics->toArray(),'', array('class' => 'form-control', 'id' => 'metrics_id')) !!}
                  </div>
            <div class="form-group">
