...
class TestController extends Controller {
	...
	public function reject($specimenID)
	{
		...
		return view('test.reject')->with('specimen', $specimen)
	...
	public function changeSpecimenType()
	{
		...
		return view('test.changeSpecimenType')->with('test', $test);
	}
...
/**
	...
	{
		return view('test.viewDetails')->with('test', Test::find($testID));
	}
