		...
		<!-- if there are creation errors, they will show here -->
			...
			{!! Form::open(array('route' => array('user.index'), 'id' => 'form-create-user', 'files' => true)) !!}
				...
				<div class="form-group">
					...
					{!! Form::text('username', old('username'), ["placeholder" => "jsiku",
						'class' => 'form-control']) !!}
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					{!! Form::text('full_name', old('full_name'), ["placeholder" => "Jay Siku", 
						'class' => 'form-control']) !!}
				</div>
				<div class="form-group">
					{!! Form::label('email', trans('messages.email-address')) !!}
					{!! Form::email('email', old('email'), ["placeholder" => "j.siku@ilabafrica.ac.ke", 
						'class' => 'form-control']) !!}
				</div>
				<div class="form-group">
					{!! Form::label('designation', trans('messages.designation')) !!}
					{!! Form::text('designation', old('designation'), ["placeholder" => "Lab Technologist", 
						'class' => 'form-control']) !!}
				</div>
                <div class="form-group">
                    {!! Form::label('gender', trans('messages.gender')) !!}
                    <div>{!! Form::radio('gender', App\Models\Patient::MALE, true) !!}
                    	<span class='input-tag'>{!!trans('messages.male')!!}</span></div>
                    <div>{!! Form::radio("gender", App\Models\Patient::FEMALE, false) !!}
