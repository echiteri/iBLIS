...
@section("content")
    <div>
        <ol class="breadcrumb">
          ...
          <li><a href="{!! route('test.index') !!}">{!! Lang::choice('messages.test', 2) !!}</a></li>
        ...
        {!! Form::open(array('route' => 'test.referAction')) !!}
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('facility_id', array(0 => '')+$facilities->lists('name', 'id'), old('facility_id'),
                        array('class' => 'form-control')) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('person', trans("messages.person")) !!}
                    {!!Form::text('person', old('person'),
                        array('class' => 'form-control'))!!}
                </div>
                <div class="form-group">
